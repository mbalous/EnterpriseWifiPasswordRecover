...
namespace EnterpriseWifiPasswordRecover
{
    class Program
    {
        ...
        public string _workingDirectory = Directory.GetCurrentDirectory() + @"\profiles\";
        public const string stage1Prefix = "stage1_";
        public const string stage2Prefix = "stage2_";
        public const string stage3Prefix = "decrypted_";
        ...
        public Program()
        {
            Console.WriteLine($"Application started as user '{Environment.UserName}'");
        ...
        /// Run as "nt authority\system" to retreive keys of every user.
        /// </summary>
        public void Stage1()
        {
            ...
            foreach (RegistryKey key in possibleKeys.Where(key => key != null))
            {
                ...
                try
                {
                    ...
                    for (int j = 0; j < subKeys.Length; ++j)
                    {
                        ...
                        if (theData != null)
                        {
                            ...
                            File.WriteAllBytes(this._workingDirectory + "/" + stage1Prefix + subKey + extension, theData);
        ...
        public void Stage2()
        {
            ...
            foreach (string profilePath in profiles)
            {
                ...
                if (!profile.Contains(stage1Prefix))
                    continue;
                ...
                try
                {
                    ...
                    try
                    {
                        ...
                        File.WriteAllBytes(this._workingDirectory + "/" + stage2Prefix + profile + extension, unprotectedBytes);
                    }
                    catch
                    {
            ...
            foreach (string profilePath in profiles)
            {
                ...
                try
                {
                    ...
                    if (theStore.password != null && theStore.password.Length > 0)
                    {
                        ...
                        sb.AppendLine("Username: " + theStore.username);
                        sb.AppendLine("Password: " + theStore.password);

                        File.WriteAllText(this._workingDirectory + "/" + stage3Prefix + profile + extension, sb.ToString());
                    }
                }
                catch
                {
        ...
        /// <summary>
        /// Decrypts a standard WPA2 PSK password
        /// Needs to be run as SYSTEM
        /// </summary>
        /// <param name="encodedPassword"></param>
        /// <returns></returns>
        public static string DecryptWirelessPassword(string encodedPassword) // Currently unused
        {
            try
            {
